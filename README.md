...
— in short: public ingress, dyndns, UPS, and the Topology B onboarding generator are designed but
not yet implemented and must be built **before** `rc.1` (a candidate may defer proof, never
existence — ADR-0012; heartbeat and alert delivery, the other two surfaces this applied to, are now
