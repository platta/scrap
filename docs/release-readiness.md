...
| **Dyndns and UPS are implemented, working capabilities** | README-only, no manifests, in either case | Yes — **and blocks `rc.1`**: an existence gap, not a proof gap (`docs/decisions/0012`) |
