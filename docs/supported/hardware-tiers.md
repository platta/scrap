...
These are directional estimates, not precise measurements — see each capability's own `README.md`
for specifics. All capabilities named above are implemented and live-tested; see
`docs/release-readiness.md` for the current evidence snapshot.
