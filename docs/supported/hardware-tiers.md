...
| **Standard** | ~6–8 GB | + Grafana (implemented) | Comfortable headroom for a handful of small applications. Logs and alert delivery are designed but not yet implemented — see `capabilities/README.md`'s Status column — so they add nothing to this tier's real footprint today |
